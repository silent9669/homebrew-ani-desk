...
The cask installs the Apple Silicon macOS 15+ `.app` from the release DMG into Applications. Artifacts are unsigned for v1.0, so macOS may show the usual Gatekeeper prompt on first launch.
